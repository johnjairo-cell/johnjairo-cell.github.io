...
<section>
<h2>Sobre Mí</h2>
<p>Mi nombre es John Jairo Montoya, y soy un apasionado de la inteligencia
artificial y su aplicación en el procesamiento de contenido multimedia, especialmente videos. Este sitio web es un escaparate de mis proyectos y experimentos en este campo.</p>
</section>
<section>
 <h2>Proyectos</h2>
  <p>Aquí hay algunos ejemplos de mi trabajo con la Inteligencia Artificial en la manipulación y análisis de videos de YouTube:</.
<ul>
...
<section id="intro">
  ...
  <video controls width="100%">
    <source src="videos/intro.mp4" type="video/mp4"> Tu navegador no soporta la reproducción de video.
</video>
</section>
...
<head>
  ...
  <style> body {font-family: Arial, sans-serif; margin: 20px; background-color: #f9f9f9; color: #333; text-align: center;}
iframe {max-width: 100%; border-radius: 12px; margin-bottom: 20px;}
.cta-buttons {display: flex; flex-wrap: wrap; justify-content: center; gap: 15px;
margin-bottom: 30px;}
.cta-buttons a {text-decoration: none; padding: 12px 20px; border-radius: 25px;
background-color: #0057ff; color: white; font-weight: bold; transition: background-color 0.3s;}
.cta-buttons a:hover {background-color: #003fba;}
.hashtags {font-size: 16px; margin-top: 20px; color: #666;}
form input, form textarea {width: 80%; max-width: 500px; padding: 10px; margin: 10px auto; border: 1px solid #ccc; border-radius: 8px;}
form button {padding: 12px 25px; background-color: #28a745; color: white; border: none; border-radius: 25px; font-weight: bold; cursor: pointer;}
